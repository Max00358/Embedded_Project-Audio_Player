...
# 
ELF := Lab2_WAVE_PLAYER.elf

# Paths to C, C++, and assembly source files.
C_SRCS += hello_world.c
C_SRCS += fatfs.c
C_SRCS += fatfs_diskio.c
C_SRCS += fatfs_nios2_de0_nano_spi.c
C_SRCS += fatfs_nios2_de1_pio.c
C_SRCS += fatfs_nios2_de1_spi.c
C_SRCS += ff.c
C_SRCS += monitor.c
C_SRCS += uart_nios2.c
CXX_SRCS :=
...
BSP_ROOT_DIR := ../Lab2_WAVE_PLAYER_bsp/
